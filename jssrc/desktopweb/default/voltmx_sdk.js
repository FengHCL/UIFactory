 ...
 voltmx.sdk.errorcodes.code_verifier_save_failed = 109;
 voltmx.sdk.errormessages.code_verifier_save_failed = "Unable to store code verifier at middleware server";
 voltmx.sdk.errorcodes.code_verifier_retrieve_failed = 110;
 voltmx.sdk.errormessages.code_verifier_retrieve_failed = "Unable to retrieve code verifier from middleware server";
 ...
 voltmx.sdk.errormessages.CORS_disabled_at_identity = "Login Failed. Please check if CORS setting is properly configured in Foundry Identity";
 ...
 voltmx.sdk.completeSingleWindowLogin = function(code, loginCompleteCallback) {
         ...
         function performTokenCall(networkResponseJSON) {
             ...
             if (!voltmx.sdk.isNullOrUndefined(networkResponseJSON[voltmx.sdk.constants.CODE_VERIFIER])) {
                 bodyParams[voltmx.sdk.constants.CODE_VERIFIER] = networkResponseJSON[voltmx.sdk.constants.CODE_VERIFIER];
             } else {
         ...
         if (voltmx.sdk.isNullOrUndefined(loginOptions)) {
             ...
             var errorObject = {};
             errorObject.code = voltmx.sdk.errorcodes.partial_login_error;
             errorObject.message = voltmx.sdk.errormessages.partial_login_error;
 ...
 function doesMFSupportsAppversioning() {
     ...
     // Note: In case of new plainjs voltmx.sdk.constants.SDK_TYPE_IDE will have 'js' value. Need to modify the case if it is implemented in 9.2 branch.
 ...
 voltmx.sdk.binary.validateUploadParams = function(uploadParams) {
     ...
     if (voltmx.sdk.isNullOrUndefined(uploadParams[voltmx.sdk.constants.FILE_OBJECT])) {
         ...
         return voltmx.sdk.error.getClientErrObj(voltmx.sdk.errorcodes.invalid_params_instance, "fileObject is not provided " + voltmx.sdk.errormessages.invalid_params_instance);
     }
     ...
     if (uploadParams[voltmx.sdk.constants.FILE_OBJECT].constructor !== File) {
         ...
         return voltmx.sdk.error.getClientErrObj(voltmx.sdk.errorcodes.invalid_params_instance, "Invalid datatype of fileObject " + voltmx.sdk.util.type(uploadParams[voltmx.sdk.constants.FILE_OBJECT]) + " " + voltmx.sdk.errormessages.invalid_params_instance);
     }
     return null;
 };
 voltmx.sdk.binary.getRequestParamsFromTemplate = function(template, templateParams, options) {
     ...
     var headers = {};
     if (parsedTemplate.hasOwnProperty(voltmx.sdk.binary.constants.HEADERS) && voltmx.sdk.util.isJsonObject(parsedTemplate[voltmx.sdk.binary.constants.HEADERS]) && Object.keys(parsedTemplate[voltmx.sdk.binary.constants.HEADERS] > 0)) {
     ...
     } else if (parsedTemplate.hasOwnProperty(voltmx.sdk.binary.constants.DOMAIN) && parsedTemplate.hasOwnProperty(voltmx.sdk.binary.constants.RELATIVE_PATH)) {
         var domain = "";
 ...
 voltmx.sdk.binary.getBinaryData = function(inputParams, streaming, downloadConfig, fileDownloadStartedCallback, chunkDownloadCompletedCallback, fileDownloadCompletedCallback, fileDownloadFailureCallback, options) {
     if (voltmx.sdk.isNullOrUndefined(downloadConfig[voltmx.sdk.binary.constants.ENDPOINT_URL]) && voltmx.sdk.isNullOrUndefined(downloadConfig[voltmx.sdk.binary.constants.DOMAIN]) && voltmx.sdk.isNullOrUndefined(downloadConfig[voltmx.sdk.binary.constants.RELATIVE_PATH])) {
         voltmx.sdk.verifyAndCallClosure(fileDownloadFailureCallback, "endpointUrl or domain and relative path is required in order to download a file");
         return;
     }
     ...
     if (parsedTemplate[voltmx.sdk.binary.constants.HTTP_STATUS_CODE] == voltmx.sdk.binary.constants.VALID_HTTP_REDIRECT_CODE) {
         ...
         options[voltmx.sdk.constants.IGNORE_MESSAGE_INTEGRITY] = true;
         var networkProvider = new voltmxNetworkProvider();
         networkProvider.get(requestParams[voltmx.sdk.binary.constants.URL], null, requestParams[voltmx.sdk.binary.constants.HEADERS], function(blobObject) {
             var successObject = {};
         ...
         voltmx.sdk.verifyAndCallClosure(fileDownloadFailureCallback, "Unhandled httpStatusCode received: " + parsedTemplate[voltmx.sdk.binary.constants.HTTP_STATUS_CODE]);
     }
 };
 voltmx.sdk.binary.uploadBinaryData = function(uploadParams, fileUploadStartedCallback, chunkUploadCompletedCallback, fileUploadCompletedCallback, fileUploadFailureCallback, options) {
     function templateFetchSuccess(uploadConfig) {
         if (voltmx.sdk.isNullOrUndefined(uploadConfig[voltmx.sdk.binary.constants.ENDPOINT_URL]) && voltmx.sdk.isNullOrUndefined(uploadConfig[voltmx.sdk.binary.constants.DOMAIN]) && voltmx.sdk.isNullOrUndefined(uploadConfig[voltmx.sdk.binary.constants.RELATIVE_PATH])) {
             voltmx.sdk.verifyAndCallClosure(fileUploadFailureCallback, "endpointUrl or domain and relative path is required in order to upload a file");
             return;
         }
         ...
         var requestParams = voltmx.sdk.binary.getRequestParamsFromTemplate(uploadConfig, uploadParams[voltmx.sdk.binary.constants.UPLOAD_PARAMS], options);
         var parsedTemplate = JSON.parse(requestParams[voltmx.sdk.constants.PROCESSED_TEMPLATE]);
         if (parsedTemplate[voltmx.sdk.binary.constants.HTTP_STATUS_CODE] == voltmx.sdk.binary.constants.VALID_HTTP_REDIRECT_CODE) {
             var requestBody;
             var fileObject;
             ...
             if (parsedTemplate[voltmx.sdk.binary.constants.UPLOAD_MODE].toLowerCase() === voltmx.sdk.binary.constants.UPLOAD_MODE_BINARY) {
                 ...
                 } else if (voltmx.sdk.isValidString(requestBodyTemplateVariable) && requestBodyTemplateVariable.indexOf(voltmx.sdk.binary.constants.FILE_CONTENT) !== -1) {
             ...
             if (requestParams[voltmx.sdk.binary.constants.METHOD].toLocaleUpperCase() === voltmx.sdk.binary.constants.HTTP_METHOD_POST) {
                 networkProvider.post(requestParams[voltmx.sdk.binary.constants.URL], requestBody, requestParams[voltmx.sdk.binary.constants.HEADERS], function(networkResponse) {
                     var successObject = {};
                 ...
                 }, parsedTemplate[voltmx.sdk.binary.constants.UPLOAD_MODE].toLowerCase(), options);
             }
         } else {
             //TODO: Handle http status which is not 309
             voltmx.sdk.verifyAndCallClosure(fileUploadFailureCallback, "Unhandled httpStatusCode received: " + parsedTemplate[voltmx.sdk.binary.constants.HTTP_STATUS_CODE]);
         }
     }
     //Invoking the template call
     var networkProvider = new voltmxNetworkProvider();
     networkProvider.post(uploadParams[voltmx.sdk.binary.constants.URL], uploadParams[voltmx.sdk.binary.constants.UPLOAD_PARAMS], uploadParams[voltmx.sdk.binary.constants.HEADERS], templateFetchSuccess, fileUploadFailureCallback, null, options);
 };
 ...
 function OAuthHandler(serviceUrl, providerName, appkey, callback, type, options, isMFVersionCompatible) {
     ...
     utilityInstancePKCE.initializePKCEObject(options);
     var urlType = "/" + type + "/";
     var isSuccess = true;
     var isLogout = false;
     ...
     if (typeof(XMLHttpRequest) !== 'undefined') {
         ...
         if (voltmx.sdk.getPlatformName() === voltmx.sdk.constants.PLATFORM_THIN_CLIENT && options[voltmx.sdk.constants.NO_POP_UP] === true) {
             ...
             metaDataManagerForLoginInSameWindow.saveCodeVerifier(codeVerifierBodyParamsJSON, saveCodeVerifierSuccessCallback, function(errorObject) {
                 isError = true;
                 loginHelperFunction(null, null, null, isError, errorObject);
             });

             function saveCodeVerifierSuccessCallback() {
                 voltmx.sdk.logsdk.info("code_verifier was saved at middleware");
                 ...
                 if (voltmx.sdk.isNullOrUndefined(userCustomDataSaveHandle)) {
                     ...
                     if (typeof(userCustomDataSaveHandle) !== 'function') {
                         ...
                         var errorObject = {};
                         errorObject.code = voltmx.sdk.errorcodes.invalid_custom_data_save_handle;
                         errorObject.message = voltmx.sdk.errormessages.invalid_custom_data_save_handle;
                         isError = true;
                         loginHelperFunction(null, null, null, isError, errorObject);
                         return;
                     }
                     ...
                     userCustomDataSaveHandle(_openWindowInSelfMode, function(err) {
                         ...
                         var errorObject = {};
                         errorObject.code = voltmx.sdk.errorcodes.custom_data_save_handle_failed;
                         errorObject.message = voltmx.sdk.errormessages.custom_data_save_handle_failed;
                         isError = true;
                         loginHelperFunction(null, null, null, isError, errorObject);
                         return;
                     })
         ...
         function handleRequestCallback(browserWidget, params) {
             ...
             if (originalUrl.indexOf(serviceUrl) >= 0) {
                 if (!isLoginCallbackInvoked && !voltmx.sdk.isNullOrUndefined(params.queryParams) && !voltmx.sdk.isNullOrUndefined(params.queryParams.code)) {
                     if (options[voltmx.sdk.constants.IS_ENABLE_IDENTITY_PKCE] && voltmx.sdk.isNullOrUndefined(params.queryParams.oauth_session_id)) {
 ...
 voltmx.setupsdks = function(initConfig, successCallBack, errorCallBack) {
     ...
     if (!voltmx.sdk.util.isNullOrUndefinedOrEmptyObject(cachedAppConfig)) {
         ...
         if ((cachedMfAppMetaData.appKey === initConfig.appKey) && (cachedMfAppMetaData.appSecret === initConfig.appSecret) && (cachedMfAppMetaData.serviceUrl === initConfig.serviceUrl) && (Math.abs(parseFloat(appConfig.svcDoc.app_version) - parseFloat(cachedSvcDoc.app_version)) < 1e-9)) {
 ...
 */
 ...
 voltmx.sdk.util.getUtilityForPKCE = (function() {
     ...
     function helperClassPKCE() {
          ...
          * @param {object} options - JSON Object containing is_enable_identity_pkce key with value as true/false
          * @return void
          */
             ...
             try {
                 ...
                 if (!voltmx.sdk.isNullOrUndefined(code_verifier) && !voltmx.sdk.isNullOrUndefined(code_challenge)) {
                     ...
                     if (options[voltmx.sdk.constants.IS_ENABLE_IDENTITY_PKCE] === true) {
                         secureParams[voltmx.sdk.constants.IS_ENABLE_IDENTITY_PKCE] = true;
                         secureParams[voltmx.sdk.constants.APP_VERIFIER] = code_verifier;
                         secureParams[voltmx.sdk.constants.APP_CHALLENGE] = code_challenge;
                     } else {
                         secureParams[voltmx.sdk.constants.IS_ENABLE_IDENTITY_PKCE] = false;
         ...
         this.appendCodeChallengeOnURL = function(url) {
             if (!voltmx.sdk.isNullOrUndefined(secureParams) && !voltmx.sdk.isNullOrUndefined(url)) {
                 if (secureParams[voltmx.sdk.constants.IS_ENABLE_IDENTITY_PKCE]) {
                     url += "&" + voltmx.sdk.constants.APP_CHALLENGE + voltmx.sdk.constants.EQUAL_TO + secureParams[voltmx.sdk.constants.APP_CHALLENGE] + "&" + voltmx.sdk.constants.KEY_APP_CHALLENGE_METHOD + voltmx.sdk.constants.EQUAL_TO + voltmx.sdk.constants.CODE_CHALLENGE_METHOD_VALUE;
                     if (voltmx.sdk.getPlatformName() === voltmx.sdk.constants.PLATFORM_THIN_CLIENT) {
                     ...
                     url += "&" + voltmx.sdk.constants.CODE_CHALLENGE + "=" + secureParams[voltmx.sdk.constants.CODE_CHALLENGE] + "&" + voltmx.sdk.constants.KEY_CODE_CHALLENGE_METHOD + "=" + voltmx.sdk.constants.CODE_CHALLENGE_METHOD_VALUE;
                 }
                 //after we passed code_challenge, we should no longer keep values with us.
                 delete secureParams[voltmx.sdk.constants.CODE_CHALLENGE];
 ...
 voltmx.sdk.util.getMetaDataManagerForLoginInSameWindow = (function() {
     ...
     function MetaDataManager() {
         ...
         function getClientStateEndpoint() {
             ...
             return middlewareServerUrl + voltmx.sdk.constants.CODE_VERIFIER_MW_STORE_ENDPOINT;
         }
         /**
         ...
         this.retrieveCodeVerifier = function(successCallback, failureCallback) {
                 voltmx.sdk.logsdk.info("Entering retrieveCodeVerifier");
                 ...
                 function _getCodeVerifier() {
                     ...
                     networkProvider.get(middlewareStateUrl, null, headers, function(response) {
                         voltmx.sdk.logsdk.info("Exiting retrieveCodeVerifier with success");
                         voltmx.sdk.verifyAndCallClosure(successCallback, response);
                     }, function(err) {
                         voltmx.sdk.logsdk.error("unable to save the code verifier at middleware " + middlewareStateUrl + " , due to " + err.message);
                         var errorObject = {};
                         errorObject.code = voltmx.sdk.errorcodes.code_verifier_retrieve_failed;
                         errorObject.message = voltmx.sdk.errormessages.code_verifier_retrieve_failed;
                         voltmx.sdk.verifyAndCallClosure(failureCallback, errorObject);
                     });
                 }
             }
         ...
         this.saveCodeVerifier = function(codeVerifierJSON, successCallback, failureCallback) {
                 voltmx.sdk.logsdk.info("Entering saveCodeVerifier");
                 voltmx.sdk.claimsRefresh(_saveCodeVerifier, failureCallback);

                 function _saveCodeVerifier() {
                     voltmx.sdk.logsdk.info("saveCodeVerifier's claims passed");
                     var middlewareStateUrl = getClientStateEndpoint();
                     var headers = {};
                     headers[voltmx.sdk.constants.KONY_AUTHORIZATION_HEADER] = voltmxRef.currentClaimToken;
                     headers[voltmx.sdk.constants.APP_KEY_HEADER] = voltmxRef.mainRef.appKey;
                     ...
                     networkProvider.post(middlewareStateUrl, codeVerifierJSON, headers, function(response) {
                         voltmx.sdk.logsdk.info("Exiting saveCodeVerifier with success");
                         voltmx.sdk.verifyAndCallClosure(successCallback, response);
                     }, function(err) {
                         voltmx.sdk.logsdk.error("unable to save the code verifier at middleware " + middlewareStateUrl + " , due to " + err.message);
                         var errorObject = {};
                         errorObject.code = voltmx.sdk.errorcodes.code_verifier_save_failed;
                         errorObject.message = voltmx.sdk.errormessages.code_verifier_save_failed;
                         voltmx.sdk.verifyAndCallClosure(failureCallback, errorObject);
                     }, voltmx.sdk.constants.CONTENT_TYPE_JSON);
                 }
             }
             /**
